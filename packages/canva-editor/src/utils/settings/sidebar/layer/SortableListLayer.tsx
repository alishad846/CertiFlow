...
// A div, not a button: the sortable drag library's defaultShouldCancelStart cancels dragging when
// the mousedown target is a <button>, which made layer rows impossible to drag-reorder.
