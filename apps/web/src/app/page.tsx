...
const workflow = [
  {
    ...
    title: 'Upload Excel',
    label: 'Data import',
    description: 'Bring recipient names, emails, roles, dates, and custom certificate fields into CertiFlow.',
    icon: Upload
  },
  {
    step: '02',
    ...
    description: 'Place dynamic fields on the certificate background while the original design stays untouched.',
    icon: FileBadge2
  },
  {
    step: '03',
    title: 'Generate PDFs',
    label: 'Bulk creation',
    description: 'Create personalized certificate PDFs for every recipient in a controlled batch.',
    icon: Layers3
  },
  {
    step: '04',
    ...
    label: 'Delivery',
    description: 'Send clean emails, retry failures, and monitor sent, pending, and failed certificates.',
    icon: MailCheck
  }
];
...
const roles = [
  {
    ...
    icon: ShieldCheck,
    tone: 'blue',
    points: ['Create companies', 'Approve top-ups', 'Control discounts', 'Monitor platform usage']
  },
  {
    title: 'Company Admin',
    icon: Users2,
...
const features = [
  {
    icon: Lock,
    title: 'Template-safe output',
    description: 'Fonts, logos, spacing, borders, and backgrounds remain exactly like the uploaded certificate design.'
  },
  {
    icon: CircleDollarSign,
    title: 'Credit control',
    description: 'Fixed credit plans, UPI requests, approvals, and discount rules keep billing predictable.'
  },
  {
    icon: BarChart3,
    title: 'Delivery visibility',
    description: 'Track sent, pending, failed, generated documents, and credit usage from one dashboard.'
  },
  {
    icon: Blocks,
    title: 'Batch automation',
    description: 'Queue-based delivery keeps bulk sending controlled, resilient, and safer for mail providers.'
  },
  {
    icon: Globe2,
    title: 'Team friendly',
    description: 'Designed for EdTech, HR, and operations teams that need a simple daily workflow.'
  },
  {
    icon: Sparkles,
    title: 'Minimal workflow',
    description: 'No heavy workflow builder. No AI noise. Just upload, generate, approve, and send.'
  }
];
    ...
    <main className="min-h-screen bg-[#f7fafc] px-4 py-4 text-slate-950 md:px-6 md:py-6">
      ...
      <div className="relative mx-auto max-w-7xl">
          ...
          <Card className="overflow-hidden border-slate-900 bg-slate-950 p-6 text-white shadow-sm md:p-8">
            ...
            <div className="mt-7 rounded-[28px] border border-white/10 bg-white/[0.04] p-4">
              <div className="rounded-3xl bg-white p-5 text-slate-950 shadow-2xl">
                <div className="flex items-center justify-between border-b border-slate-200 pb-4">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Certificate batch</p>
            ...
            <div className="mt-5 rounded-2xl border border-white/10 bg-white/[0.06] p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-white">{activeWorkflow.label}</p>
                  <p className="mt-1 text-sm leading-6 text-slate-300">{activeWorkflow.description}</p>
                </div>
              </div>
            </div>
          </Card>
        ...
        <section className="mt-6 grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
          <Card className="border-slate-200 bg-white p-7 shadow-sm md:p-8">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-600">
              Each person sees a focused workflow, so non-technical teams can operate CertiFlow without training-heavy
              onboarding.
            </p>
        ...
        <section className="mt-6">
          <Card className="overflow-hidden border-slate-900 bg-slate-950 p-0 text-white shadow-sm">
            <div className="grid gap-6 p-7 md:grid-cols-[1fr_auto] md:items-center md:p-8">
              <div className="max-w-2xl">
                <p className="flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.22em] text-sky-200">
